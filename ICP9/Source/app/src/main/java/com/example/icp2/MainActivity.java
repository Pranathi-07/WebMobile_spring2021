...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paneer = findViewById(R.id.cb_paneer);
        mushrooms = findViewById(R.id.cb_mushrooms);
        onions = findViewById(R.id.cb_onions);
    ...
    public void sendEmail() {
        ...
        boolean hasPaneer = paneer.isChecked();
        ...
        float totalPrice = calculatePrice(hasCheese, hasPaneer, hasMushrooms, hasOnions, hasPeppers, hasChicken);

        // create and store the order summary details
        String orderSummaryMessage = createOrderSummary(userName, hasCheese, hasPaneer, hasMushrooms, hasPaneer, hasPeppers,hasChicken, totalPrice);
    ...
    public void submitOrder(View view) {
        ...
        // create and store the order summary details
        String orderSummaryMessage = createOrderSummary(userName, hasCheese, hasPaneer, hasMushrooms, hasOnions, hasPeppers,hasChicken, totalPrice);
...
// Order Summary Details
    private String createOrderSummary(String userName, boolean hasCheese,boolean hasPaneer, boolean hasMushrooms,boolean hasOnions, boolean hasPeppers, boolean hasChicken, float price) {
     ...
     * @return total Price
     */
    private float calculatePrice(boolean hasCheese, boolean hasPaneer, boolean hasMushrooms, boolean hasOnions, boolean hasPeppers, boolean hasChicken) {
        int basePrice = PIZZA_PRICE;
        if (hasCheese) {
            basePrice += CHEESE_PRICE;
        }
        if (hasPaneer) {
            basePrice += PANEER_PRICE;
        }
        if (hasMushrooms) {
